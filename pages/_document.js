    ...
    return (
      <Html>
        <Head>
          ...
          <link
            rel="shortcut icon"
            href="/favicon-ape-experience.png"
            type="icon/png"
            sizes="32x32"
          ></link>
          <link
          ...
          <noscript
            dangerouslySetInnerHTML={{
              __html:
                "</noscript><script src=\"https://unpkg.com/scrollreveal\"></script>\r\n<script>\r\n    ScrollReveal({ reset: true });\r\n</script>\r\n<!-- Google tag (gtag.js) -->\r\n<script async src=\"https://www.googletagmanager.com/gtag/js?id=G-7JG7J3T4NX\"></script>\r\n<script>\r\n  window.dataLayer = window.dataLayer || [];\r\n  function gtag(){dataLayer.push(arguments);}\r\n  gtag('js', new Date());\r\n\r\n  gtag('config', 'G-7JG7J3T4NX');\r\n</script><noscript>",
            }}
          ></noscript>
        </Head>
        <body>
          ...
          <script
            ...
            src="https://www.googletagmanager.com/gtag/js?id=7854580281"
            async
          ></script>
          <script
            type="text/javascript"
